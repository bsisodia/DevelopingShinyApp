...
The application is using Weight & Height to compute BMI as first basis for health risk. BMI above 24 is known for overweight and over 30 is obesity. So, we are giving a risk factor of 0.4 and 0.6 for these two cases.
